...
if ($mysqli->query("CREATE DATABASE if0_35937576_home") === TRUE) {
    echo "<p>Database home created</P>";
}
else
{
    echo "Error creating home database: " . mysqli_connect_error()."<br>";
}
//select a database to work with
$mysqli->select_db("if0_35937576_home");
   Echo ("Selected the home database");
